...
def plot_one_box(x, img, color=None, label=None, line_thickness=3):
    ...
    if label:
        ...
        t_size = cv2.getTextSize(label, 0, fontScale=tl / 3, thickness=tf)[0]
        font_size = t_size[1]
        font = ImageFont.truetype('C:/GOY/my_project/python_yolov5/yolov5-5.0/data/font_zt/simhei.ttf', font_size)
...
def plot_one_box_PIL(box, img, color=None, label=None, line_thickness=None):
    ...
    if label:
        ...
        font = ImageFont.truetype("C:/GOY/my_project/python_yolov5/yolov5-5.0/data/font_zt/simhei.ttf", fontsize)
